        ...
        <div className="bg-white max-h-[fit] shadow-lg rounded-2xl px-3 py-4 cursor-pointer hover:-translate-y-2 transition-all relative">
            ...
            <Link to={`/product/${product.id}`}>
                ...
                <div className="justify-center absolue bottom-[5px] mt-1 ml-auto mr-auto">
                    ...
                    <a type='button' onClick={() => addToCart(product.id)} className="group w-full my-1 p-2 inline-flex h-auto items-center justify-center overflow-hidden rounded-md bg-slate-800 px-3 font-medium text-neutral-200">
